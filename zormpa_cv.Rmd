...
- <i class="fa fa-lightbulb-o"></i> **Research**: Project management, experimental design, data analysis
- <i class="fa fa-file-alt"></i> **Writing**: Academic writing, publishing, copy-editing
- <i class="fa fa-laptop"></i> **Programming**: R (tidyverse), git and GitHub, Presentation
...
I am a PhD student researching the interface of language and memory. I am currently looking for positions that will allow me to pursue my passion for social science and open research.
...
Poster presented at the 26<sup>th</sup> Architectures and Mechanisms for Language Processing (AMLaP) conference.
